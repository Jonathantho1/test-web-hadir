...
public class PerjalananDinasPage {
    ...
    @FindBy(xpath = "(//p[@class='MuiTypography-root MuiTypography-body1 css-aqx7sf'][normalize-space()='Perjalanan Dinas'])[1]")
    private WebElement menuPerjalananDinas;
    ...
    public void clickMenuperjalanandinas(){
        DriverSingleton.delay(3);
        menuPerjalananDinas.click();
    }
